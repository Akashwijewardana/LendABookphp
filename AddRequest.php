...
<form  method="post" action="php/sendRequest.php" class="well form-horizontal" >

<h1 class="text-center" >Request Book</h1><br><br>
...
<div class="form-group">
  <label class="col-md-4 control-label">Type (Book or Video)</label>  
  <div class="col-md-4 inputGroupContainer">
  <div class="input-group">
  <span class="input-group-addon"><i class="bi bi-book"></i></span>
 <input  name="type" value=""  placeholder="type"  class="form-control"  type="text">
    </div>
  </div>
</div>
